      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 6:
            ...
            _batchId = Math.floor(blockNumber / BATCH_SIZE); // We claim the buy order, with the blockNumber of the emitted open order

            _context5.next = 11;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(toAnj ? fundraisingContract.claimBuyOrder(account, _batchId, antAddress, {
              gasLimit: 500000
            }) : fundraisingContract.claimSellOrder(account, _batchId, antAddress, {
              gasLimit: 500000
            }));
...
function useWaitForBatchToFinish() {
  ...
  return Object(react__WEBPACK_IMPORTED_MODULE_2__["useCallback"])(function _callee5(openOrderTransactionHash) {
    var finished, _await$ethersProvider2, blockNumber, currentBatchId;
...
//# sourceMappingURL=index.js.07326443634821cb4311.hot-update.js.map