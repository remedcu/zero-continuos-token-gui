...
function useClaimOrderReceiptAmount() {
  var _useWalletAugmented6 = Object(_wallet__WEBPACK_IMPORTED_MODULE_6__["useWalletAugmented"])(),
      ...
      wallet = _useWalletAugmented6.wallet;

  return Object(react__WEBPACK_IMPORTED_MODULE_2__["useCallback"])(function _callee6(hash) {
    var abi, _getKnownContract13, _getKnownContract14, antAddress, _getKnownContract15, _getKnownContract16, anjAddress, abiInterface, transactionReceipt, parsedTransferLog, amount;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 7:
            ...
            debugger;
            transactionReceipt.logs.filter(function (log) {
              return log.address === antAddress || log.address === anjAddress;
            }).filter(function (log) {
              return log.args[1] === wallet.address;
            });
...
//# sourceMappingURL=index.js.16619ae6f807a7736248.hot-update.js.map